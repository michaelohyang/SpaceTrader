...
public class SkillConfigurationController {
    ...
    public static void showNewStage() {
        newstage.show();
    }
        ...
        try {
            if (charName2.getLength() > 0 && checked) {
                FXMLLoader loader = new FXMLLoader(getClass()
                    .getResource("../fxml/SkillConfiguration.fxml"));
                Parent root = (Parent) loader.load();
                PlayerController playerController = loader.getController();
                playerController.initData(charName2.getText(), getDifficult());
                GameGuiController.getDiff(difficult);
                newstage = new Stage();
    ...
    @FXML//To character overview Page
